...
## Project Structure
    ...
    ├── ideapros_llc_knowbo_32430  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_knowbo_32430`
...
2. Clone this repo and `cd ideapros_llc_knowbo_32430`
